...
$viewBtn.on('click',function(){
    ...
    //삼항조건연산자 활용
    //조건 ? 참일때결과 : 거짓일때결과;
    modeCount  == 0 ? //modeCount 0과 같으면?(0 == 다크모드)
    $viewBtn.children('img').attr('src','https://cdn-icons-png.flaticon.com/128/17406/17406104.png') //달
    : $viewBtn.children('img').attr('src','https://cdn-icons-png.flaticon.com/128/439/439842.png'); //해
