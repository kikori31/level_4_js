...
let m_showHide_Boolean = 0; //boolean: 참,거짓
//메뉴가 안보인다 0
//메뉴가 보인다 1
...
function m_navfunc(color='#222', rightVal='-100%', opacityVal=0){
    m_showHide_Boolean = !m_showHide_Boolean; /* !오른쪽변수:느낌표 옆에 오른쪽변수를 반전해서 왼쪽에 대입한다. */
    ...
    m_nav_bg.style.transition='right 0.4s, opacity 1s'; //css에서 써도 되고 js에서도 써도 된다.
}
